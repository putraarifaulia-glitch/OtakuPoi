...
@section('content')
    <main class="container mx-auto px-4 py-12">
        <div class="mb-12">
            <h2 class="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">{{ $studioName }}</h2>
            <p class="text-gray-500 dark:text-gray-400">Discover anime produced by this studio.</p>
        </div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8 mb-12">
            ...
            @empty
                <div class="col-span-full py-20 text-center bg-white dark:bg-dark-card rounded-3xl shadow-sm border border-gray-100 dark:border-dark-border transition-colors">
                    <p class="text-xl font-bold text-gray-800 dark:text-gray-200">No anime found for this studio.</p>
                </div>
            @endforelse
        </div>
